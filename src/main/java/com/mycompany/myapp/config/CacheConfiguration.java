...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.mycompany.myapp.domain.Todo.class.getName());
            ...
            createCache(cm, com.mycompany.myapp.domain.Order.class.getName() + ".orderLines");
            ...
            createCache(cm, com.mycompany.myapp.domain.Client.class.getName() + ".orders");
