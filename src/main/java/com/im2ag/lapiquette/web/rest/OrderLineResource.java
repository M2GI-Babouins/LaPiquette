...
import com.im2ag.lapiquette.repository.OrderLineRepository;
import com.im2ag.lapiquette.service.OrderLineService;
...
/**
 * REST controller for managing {@link com.im2ag.lapiquette.domain.OrderLine}.
 */
@RestController
@RequestMapping("/api")
public class OrderLineResource {
    ...
    public ResponseEntity<List<OrderLine>> getAllOrderLines(Pageable pageable) {
        ...
        Page<OrderLine> page = orderLineService.findAll(pageable);
