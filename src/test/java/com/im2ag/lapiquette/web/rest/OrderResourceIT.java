...
class OrderResourceIT {
    ...
    private static final Boolean DEFAULT_BASKET = false;
    private static final Boolean UPDATED_BASKET = true;
    ...
    void createOrder() throws Exception {
        ...
        assertThat(testOrder.getBasket()).isEqualTo(DEFAULT_BASKET);
    }
    ...
    void getAllOrders() throws Exception {
        ...
        restOrderMockMvc
            ...
            .andExpect(jsonPath("$.[*].basket").value(hasItem(DEFAULT_BASKET.booleanValue())));
    }
    ...
    void putNewOrder() throws Exception {
        ...
        updatedOrder.totalPrice(UPDATED_TOTAL_PRICE).datePurchase(UPDATED_DATE_PURCHASE).basket(UPDATED_BASKET);
        ...
        assertThat(testOrder.getBasket()).isEqualTo(UPDATED_BASKET);
    }
    ...
    void partialUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.totalPrice(UPDATED_TOTAL_PRICE).basket(UPDATED_BASKET);
    ...
    void fullUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.totalPrice(UPDATED_TOTAL_PRICE).datePurchase(UPDATED_DATE_PURCHASE).basket(UPDATED_BASKET);
