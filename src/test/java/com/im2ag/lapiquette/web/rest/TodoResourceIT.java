...
import com.im2ag.lapiquette.repository.TodoRepository;
...
class TodoResourceIT {
    ...
    public static Todo createEntity(EntityManager em) {
        Todo todo = new Todo().name(DEFAULT_NAME).count(DEFAULT_COUNT);
        return todo;
    }
    ...
    public static Todo createUpdatedEntity(EntityManager em) {
        Todo todo = new Todo().name(UPDATED_NAME).count(UPDATED_COUNT);
        return todo;
    }
    ...
    void createTodo() throws Exception {
        ...
        assertThat(testTodo.getCount()).isEqualTo(DEFAULT_COUNT);
    }
    ...
    void putNewTodo() throws Exception {
        ...
        updatedTodo.name(UPDATED_NAME).count(UPDATED_COUNT);
        ...
        assertThat(testTodo.getCount()).isEqualTo(UPDATED_COUNT);
    }
    ...
    void partialUpdateTodoWithPatch() throws Exception {
        ...
        partialUpdatedTodo.name(UPDATED_NAME).count(UPDATED_COUNT);
